...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> User Wise Total Revenue</div>
			<div class="panel-body">
				<table class="table table-hover table-striped table-bordered" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">Name</th>
			  			<th style="width:20%;">Total Revenue by User (₹)</th>
			  		</tr>
			  	</thead>
			  	<tbody>
					<?php while ($orderResult = $userwiseQuery->fetch_assoc()) { ?>
						<tr>
							...
							<td><?php echo round($orderResult['totalorder'],2)?></td>
